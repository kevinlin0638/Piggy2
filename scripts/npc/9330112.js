...
/*以下為要修改的*/
var rates = [1000000000,60000,430000,500000];//總共100萬 最好->最差
...
var itemListAdvanced = Array(
	...
	Array(1052294, 1, 0),//摩登原始人套裝
	Array(1052710, 1, 0),//小布娃娃普卡
	Array(1052711, 1, 0),//小布娃娃凌卡
	Array(1052777, 1, 0),//光月照影
	Array(1052778, 1, 0),//花月映容
	Array(1052779, 1, 0),//桃椿戀夜
	Array(1052780, 1, 0),//風來紅衣
	Array(1052762, 1, 0),
	Array(1052948, 1, 0),//殺人鯨睡衣
	Array(1052963, 1, 0),//比基尼
	Array(1053084, 1, 0),//閃炫方塊衣服
	Array(1053110, 1, 0)
);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		var ps = conn.prepareStatement("SELECT * FROM lottery WHERE type=9330112 ORDER BY id desc LIMIT 5");
            ...
            if (canUse) {
                ...
                if (item == -1) {
                    ...
                    if (InsertData) {
                        ...
                        insert.setInt(6, 9330112);
                        insert.executeUpdate(); //更新
                        insert.close();
						var time = item[2] == 0?"":("為期" +item[2]+ "天");
						cm.gainGachaponItem(item[0], item[1], "劍士轉蛋機", true, item[2]);
