...
function action(mode, type, selection) {
	items =  Array(
		Array(2000005, // 欲合成之道具 ID
			[[0, 300], [2, 40], [3, 50]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
		...
		Array(1112915, // 欲合成之道具 ID
			[[0, 300]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 5, 5, 5, 5, 5, 5, 15], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),
