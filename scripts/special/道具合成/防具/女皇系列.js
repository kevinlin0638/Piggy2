...
function action(mode, type, selection) {
	items =  Array(
		Array(1003172, // 欲合成之道具 ID
			[[4310000, 15],[4008000, 10],[4260004, 20],[4260005, 20],[0,20000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1003173, // 欲合成之道具 ID
			[[4310000, 15],[4008002, 10],[4260004, 20],[4260005, 20],[0,20000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1003174, // 欲合成之道具 ID
			[[4310000, 15],[4008003, 10],[4260004, 20],[4260005, 20],[0,20000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1003175, // 欲合成之道具 ID
			[[4310000, 15],[4008001, 10],[4260004, 20],[4260005, 20],[0,20000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1003176, // 欲合成之道具 ID
			[[4310000, 15],[4008003, 10],[4260004, 20],[4260005, 20],[0,20000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
