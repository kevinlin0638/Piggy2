...
function action(mode, type, selection) {
	items =  Array(
		Array(1102481, // 欲合成之道具 ID
			[[4022003, 20],[4007007, 15],[4008000, 200],[4260006, 350],[4260007, 300],[4260008, 250],[0,200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 0,0,0,0,10,10,7], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1102482, // 欲合成之道具 ID
			[[4022003, 20],[4007007, 15],[4008002, 200],[4260006, 350],[4260007, 300],[4260008, 250],[0,200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 0,0,0,0,10,10,7], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1102483, // 欲合成之道具 ID
			[[4022003, 20],[4007007, 15],[4008003, 200],[4260006, 350],[4260007, 300],[4260008, 250],[0,200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 0,0,0,0,10,10,7], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1102484, // 欲合成之道具 ID
			[[4022003, 20],[4007007, 15],[4008001, 200],[4260006, 350],[4260007, 300],[4260008, 250],[0,200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 0,0,0,0,10,10,7], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1102485, // 欲合成之道具 ID
			[[4022003, 20],[4007007, 15],[4008003, 200],[4260006, 350],[4260007, 300],[4260008, 250],[0,200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 0,0,0,0,10,10,7], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
