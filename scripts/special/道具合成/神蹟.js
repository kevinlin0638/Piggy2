...
function action(mode, type, selection) {
	items =  Array(
		Array(1112915, // 欲合成之道具 ID
			[[4021030, 2],[4021029, 2],[0, 66666]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[true, 1, 1, 1, 1, 1, 1, 5], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			10, //等級限制
			true,
			1),
		Array(4030004, // 欲合成之道具 ID
			[[4021029, 1],[0, 66666]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
		...
		Array(2049122, // 欲合成之道具 ID
			...
			true,
			3),
		Array(2049123, // 欲合成之道具 ID
			[[4021029, 2],[0, 66666]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			10, //等級限制
