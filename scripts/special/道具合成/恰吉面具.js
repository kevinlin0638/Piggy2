...
function action(mode, type, selection) {
	items =  Array(
		Array(1012167, // 欲合成之道具 ID
			[[1012164, 1],[4260005, 100],[4008000, 30],[4008001, 30],[4008002, 30],[4008003, 30],[0, 10000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012168, // 欲合成之道具 ID
			[[1012167, 1],[4260006, 100],[4008000, 50],[4008001, 50],[4008002, 50],[4008003, 50],[0, 50000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012169, // 欲合成之道具 ID
			[[1012168, 1],[4260007, 100],[4008000, 80],[4008001, 80],[4008002, 80],[4008003, 80],[0, 80000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012170, // 欲合成之道具 ID
			[[1012169, 1],[4260008, 100],[4008000, 100],[4008001, 100],[4008002, 100],[4008003, 100],[0, 100000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012171, // 欲合成之道具 ID
			[[1012170, 1],[4260008, 150],[4008000, 100],[4008001, 100],[4008002, 100],[4008003, 100],[0, 200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012172, // 欲合成之道具 ID
			[[1012171, 1],[4260008, 200],[4008000, 100],[4008001, 100],[4008002, 100],[4008003, 100],[0, 200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012173, // 欲合成之道具 ID
			[[1012172, 1],[4260008, 250],[4008000, 150],[4008001, 150],[4008002, 150],[4008003, 150],[0, 200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
			true),
		Array(1012174, // 欲合成之道具 ID
			[[1012173, 1],[4260008, 250],[4008000, 150],[4008001, 150],[4008002, 150],[4008003, 150],[0, 200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			70, //等級限制
