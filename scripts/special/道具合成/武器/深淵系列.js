...
function action(mode, type, selection) {
	items =  Array(
		Array(1342082, // 欲合成之道具 ID
			[[4310001, 15],[4008001, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1332225, // 欲合成之道具 ID
			[[4310001, 15],[4008001, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
		...
		Array(1472214, // 欲合成之道具 ID
			...
			-1, //等級限制
			true),// 是否顯示
		Array(1302275, // 欲合成之道具 ID
			[[4310001, 15],[4008000, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1312153, // 欲合成之道具 ID
			[[4310001, 15],[4008000, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
		...
		Array(1442223, // 欲合成之道具 ID
			...
			-1, //等級限制
			true),// 是否顯示
		Array(1372177, // 欲合成之道具 ID
			[[4310001, 15],[4008002, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1382208, // 欲合成之道具 ID
			[[4310001, 15],[4008002, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1452205, // 欲合成之道具 ID
			[[4310001, 15],[4008003, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1462193, // 欲合成之道具 ID
			[[4310001, 15],[4008003, 100],[4260005, 20],[4260006, 20],[0,40000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
