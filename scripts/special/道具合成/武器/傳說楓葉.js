...
function action(mode, type, selection) {
	items =  Array(
		Array(1342059, // 欲合成之道具 ID
			[[4032222 , 5],[4008001, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1332177, // 欲合成之道具 ID
			[[4032222 , 5],[4008001, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
		...
		Array(1472168, // 欲合成之道具 ID
			...
			-1, //等級限制
			true),// 是否顯示
		Array(1302200, // 欲合成之道具 ID
			[[4032222 , 5],[4008000, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1312106, // 欲合成之道具 ID
			[[4032222 , 5],[4008000, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
		...
		Array(1442164, // 欲合成之道具 ID
			...
			-1, //等級限制
			true),// 是否顯示
		Array(1372126, // 欲合成之道具 ID
			[[4032222 , 5],[4008002, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1382152, // 欲合成之道具 ID
			[[4032222 , 5],[4008002, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1452156, // 欲合成之道具 ID
			[[4032222 , 5],[4008003, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			-1, //等級限制
			true),// 是否顯示
		Array(1462146, // 欲合成之道具 ID
			[[4032222 , 5],[4008003, 2],[4021013, 30],[4260002, 20],[0,5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
