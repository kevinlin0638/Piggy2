...
function action(mode, type, selection) {
	items =  Array(
		...
		Array(1032209, // 欲合成之道具 ID
			[[1032208, 1],[4260008, 100],[4008000, 100],[4008001, 100],[4008002, 100],[4008003, 100],[0, 100000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
		...
		Array(1032219, // 欲合成之道具 ID
			[[1032209, 1],[4021030,1],[4260008, 250],[4008000, 150],[4008001, 150],[4008002, 150],[4008003, 150],[0, 200000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
