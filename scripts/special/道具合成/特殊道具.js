...
function action(mode, type, selection) {
	items =  Array(
		Array(1022212, // 欲合成之道具 ID
			[[4021004, 5],[4021008, 5],[4310010, 5],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 15000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1032225, // 欲合成之道具 ID
			[[4011002 , 5],[4011005 , 5],[4310010, 5],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 15000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1152161, // 欲合成之道具 ID
			[[4011006 , 5],[4011008 , 5],[4310010, 5],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 15000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1132248, // 欲合成之道具 ID
			[[4021000 , 5],[4021007 , 5],[4310010, 5],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 15000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1122272, // 欲合成之道具 ID
			[[4021001 , 5],[4021005, 5],[4310010, 5],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 15000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
		...
		Array(1112951, // 欲合成之道具 ID
			[[4021030, 1],[4260008, 100],[4008000, 80],[4008001, 80],[4008002, 80],[4008003, 80],[0, 300000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1112952, // 欲合成之道具 ID
			[[4021030, 1],[4021021 , 1],[4260008, 100],[4008000, 80],[4008001, 80],[4008002, 80],[4008003, 80],[0, 300000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1113070, // 欲合成之道具 ID
			[[4021030, 1],[4021022 , 1],[4260008, 100],[4008000, 80],[4008001, 80],[4008002, 80],[4008003, 80],[0, 300000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1672069, // 欲合成之道具 ID
			[[4021010, 15],[4310000 , 5],[4310001 , 5],
			[4021021, 5],[4021022 , 5],[4021020 , 10],
			[4260008, 50],[4008000, 50],[4008001, 50],[4008002, 50],[4008003, 50],
			[0, 500000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
