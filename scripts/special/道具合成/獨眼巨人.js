...
function action(mode, type, selection) {
	items =  Array(
		Array(1022190, // 欲合成之道具 ID
			[[1022189, 1],[4011000 , 5],[4260005, 100],[4008000, 30],[4008001, 30],[4008002, 30],[4008003, 30],[0, 10000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1022191, // 欲合成之道具 ID
			[[1022190, 1],[4011003, 5],[4260006, 100],[4008000, 50],[4008001, 50],[4008002, 50],[4008003, 50],[0, 50000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1022192, // 欲合成之道具 ID
			[[1022191, 1],[4021006 , 5],[4260007, 100],[4008000, 80],[4008001, 80],[4008002, 80],[4008003, 80],[0, 80000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
			true),
		Array(1022193, // 欲合成之道具 ID
			[[1022192, 1],[4011007 , 5],[4021030, 1],[4260008, 100],[4008000, 100],[4008001, 100],[4008002, 100],[4008003, 100],[0, 100000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			160, //等級限制
