...
function action(mode, type, selection) {
	items =  Array(
		Array(1132212, // 欲合成之道具 ID
			[[1132211, 1],[4011000 , 3],[4260005, 100],[4008000, 10],[4008001, 10],[4008002, 10],[4008003, 10],[0, 1000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			0, //等級限制
			true),
		Array(1132213, // 欲合成之道具 ID
			[[1132212, 1],[4011003 , 3],[4260006, 100],[4008000, 20],[4008001, 20],[4008002, 20],[4008003, 20],[0, 5000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			0, //等級限制
			true),
		Array(1132214, // 欲合成之道具 ID
			[[1132213, 1],[4011005 , 3],[4260007, 100],[4008000, 30],[4008001, 30],[4008002, 30],[4008003, 30],[0, 8000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			0, //等級限制
			true),
		Array(1132215, // 欲合成之道具 ID
			[[1132214, 1],[4011006 , 3],[4260008, 100],[4008000, 40],[4008001, 40],[4008002, 40],[4008003, 40],[0, 10000000]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			false, // 是否批量合成
			0, //等級限制
