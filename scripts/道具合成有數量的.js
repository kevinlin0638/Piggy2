...
function action(mode, type, selection) {
	items =  Array(
		Array(2060003, // 欲合成之道具 ID
				[[4007001, 1], [4260000, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
		...
		Array(2002020, // 欲合成之道具 ID
			[[4025004, 1], [4260000, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2002021, // 欲合成之道具 ID
			[[4025005, 1], [4260000, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2002022, // 欲合成之道具 ID
			[[4025006, 1], [4260001, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2000004, // 欲合成之道具 ID
			[[4025007, 1], [4260002, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2002023, // 欲合成之道具 ID
			[[4025008, 1], [4260002, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2000005, // 欲合成之道具 ID
			[[4025008, 1], [4260003, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
		...
		Array(2050004, // 欲合成之道具 ID
			[[4023005, 1], [4260004, 1]], //欲合成之道具 1 個所需材料 [id, num], id = 0 楓幣, id = 1 Gash, id = 2 楓點, id = 3 贊助點
			[false], //是否特殊強化, str, dex, int, luk, watk, matk, addi_slot
			-1, //是否限制時間, 時間
			true, // 是否批量合成
			-1, //等級限制
    ...
    if (status == 0 && mode == 1) {
		...
		if(sele_item[4] && req_num == -1){
			var selStr = "您選擇的物品是 #b#v" + sele_item[0] + "##z" + sele_item[0] + "# #r(" +sele_item[7] +" 單位)#k所需材料如下 : \r\n"
			if(sele_item[5] > 0)
		...
		if(!cm.canHold(sele_item[0], req_num * sele_item[7])){
		...
		if(sele_item[2][0]){
			...
			cm.gainItemPeriod(sele_item[0], req_num * sele_item[7], sele_item[3]);
		}
		cm.sendOk("製作 #b#v" + sele_item[0] + "##t" + sele_item[0] + "# #r(" + (req_num * sele_item[7]) + " 單位)#k - 成功!" );
		cm.dispose();
	}
}
