...
public final class ServerConfig {
     ...
     *方塊楓幣費用
     */
    @Property(key = "channel.rate.cubemoney", defaultValue = "100")
    public static int WORLD_CUBE_MONEY;
    /**
     * 禁止所有交易
     */
     ...
     * 服务器本地IP设置
     */
    @Property(key = "world.interface", defaultValue = "127.0.0.1")
     ...
     * 突破之石上限
     */
    @Property(key = "channel.player.limitbreak", defaultValue = "2100000000")
